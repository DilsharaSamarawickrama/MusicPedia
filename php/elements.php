                            ...
                            <div class="classynav">
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <?php
                                        ...
                                        <a href=\"logout.php\" id=\"logout\"><i class=\"fa fa-sign-out fa-2x\" aria-hidden=\"true\"></i></a>
                                    </div>";
                                        }
                                        else{
                                            echo "<div class=\"login-register-btn mr-50\">
                                        <a href=\"login.php\" id=\"login\"><i class=\"fa fa-sign-in fa-2x\" aria-hidden=\"true\"></i></a>
                                    </div>";
                                        }
                                    ?>
                                    <!-- Cart Button -->
